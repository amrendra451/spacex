...
const Home = ({ error, launchesData, err }) => {
  ...
  useEffect(() => {
    axios.get(`https://api.spaceXdata.com/v3/launches?limit=100`, { params: filter }).then(res => setLaunches(res.data));
  ...
  return (
    <div className="container mx-auto px-4">
      <Head>
        ...
        <meta name="keywords" content="ReactJS, Tailwind CSS, JavaScript" />
        <meta name="author" content="Amrendra Nath" />
